...
public class ChunkGeneratorTest implements IChunkGenerator {
    ...
    public ChunkGeneratorTest(World worldIn, long seed, String generatorOptions)
    {
        {
        ...
        {
			try {
				Constructor<ChunkGeneratorSettings> constructor = ChunkGeneratorSettings.class.getDeclaredConstructor(ChunkGeneratorSettings.Factory.class);
	        	constructor.setAccessible(true);
	        	ChunkGeneratorSettings.Factory factory = new ChunkGeneratorSettings.Factory();
	        	factory.setDefaults();
				this.settings = constructor.newInstance(factory);
